...
module Instance : sig
  ...
  val would_log : t -> Ppx_log_types.Level.t option -> bool @@ portable
...
module Global : sig
  ...
  val would_log : Ppx_log_types.Level.t option -> bool @@ portable
  val default : return_type
...
module Portable : sig
  module Instance : sig
    ...
    [@@alert
      ppx_log_syntax_not_in_scope
        "In order to use portable [ppx_log], you need to have a \
         [Ppx_log_syntax.Portable] in scope. This is usually provided with [open \
         Async_log.Ppx_log_syntax] or [open Async_log_kernel.Ppx_log_syntax]."]
  end
