...
(** This type can be created with ppx [%log.make_raw].
    ...
    Use this type when you want to create a logable message while also preserving structural information.
*)
type t = Message_source.t * Message_data.t

(** It's common to want to create a raw message, and also embed it as a sexp in
    downstream info types like errors. This helper function provides this. *)
